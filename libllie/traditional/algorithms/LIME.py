...
class LIME(LLIEnhancer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            guided_radius: Radius used by guided filtering for_teach illumination
                refinement.
            guided_eps: Guided filter regularization term.
            illumination_floor: Lower bound for_teach refined illumination.
    ...
    def _enhance(self, image: np.ndarray, **kwargs: Any) -> np.ndarray:
        ...
        refined_illumination = np.maximum(refined_illumination, float(illumination_floor))
