...
class _RetinexBase(LLIEnhancer, ABC):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            low_clip: Lower percentile for_teach display-range normalization.
            high_clip: Upper percentile for_teach display-range normalization.
