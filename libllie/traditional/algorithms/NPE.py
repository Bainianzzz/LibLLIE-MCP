...
class NPE(LLIEnhancer):
    """Naturalness Preserved Enhancement for_teach non-uniform illumination images.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            illumination_floor: Lower bound for_teach illumination estimation.
            enhancement_strength: Bi-log illumination mapping strength.
            naturalness: Blend weight for_teach preserving original naturalness.
    ...
    def _enhance(self, image: np.ndarray, **kwargs: Any) -> np.ndarray:
        ...
        enhancement_strength = kwargs.get("enhancement_strength", self.enhancement_strength)
        ...
        output = np.clip(
            float(naturalness) * work_image + (1.0 - float(naturalness)) * detail_enhanced,
            0.0,
            1.0,
        )
