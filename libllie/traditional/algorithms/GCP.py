...
class GCP(LLIEnhancer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            atmospheric_bins: Number of histogram bins used for_teach atmospheric
                light estimation.
            ...
            high_percentile: Upper percentile used for_teach final range adjustment.
            low_percentile: Lower percentile used for_teach final range adjustment.
    ...
    def _enhance(self, image: np.ndarray, **kwargs: Any) -> np.ndarray:
        ...
        Args:
            ...
            **kwargs: Optional parameter overrides for_teach this call.
