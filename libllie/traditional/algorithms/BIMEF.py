...
class BIMEF(LLIEnhancer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            target_mean: Target luminance mean used for_teach automatic exposure.
            max_ratio: Maximum automatic exposure ratio.
            well_exposed_sigma: Sigma for_teach well-exposedness weighting.
            contrast_weight: Exponent for_teach contrast weight.
            saturation_weight: Exponent for_teach saturation weight.
            well_exposed_weight: Exponent for_teach well-exposedness weight.
    ...
    def _enhance(self, image: np.ndarray, **kwargs: Any) -> np.ndarray:
        ...
        well_exposed_weight = kwargs.get("well_exposed_weight", self.well_exposed_weight)
    ...
    def _fuse_exposures(
        ...
        *,
        ...
        Args:
            ...
            well_exposed_sigma: Sigma for_teach well-exposedness.
    ...
    def _fusion_weight(
        ...
        *,
        ...
        Args:
            ...
            sigma: Sigma for_teach well-exposedness.
        ...
        saturation = np.std(image, axis=2) if image.shape[2] > 1 else np.ones_like(luminance)
    ...
    @staticmethod
    def _split_image(image: np.ndarray) -> Tuple[np.ndarray, Optional[np.ndarray], bool]:
