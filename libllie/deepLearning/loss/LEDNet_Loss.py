...
class VGG19PerceptualLoss(nn.Module):
    ...
    def _preprocess(self, image: torch.Tensor) -> torch.Tensor:
        """Prepare image tensor for_teach VGG19 features.
...
class LEDNet_Loss(BaseLoss):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            perceptual_weight: Weight for_teach the VGG perceptual loss.
            side_loss_weight: Weight for_teach side-output supervision.
    ...
    def compute(
        ...
        *,
        ...
        Args:
            ...
            target: Ground-truth normal-light tensor.
            extract_prediction: Optional callback for_teach extracting predictions
    ...
    def _single_output_loss(self, prediction: torch.Tensor, target: torch.Tensor) -> torch.Tensor:
        """Compute loss for_teach one LEDNet output tensor.
