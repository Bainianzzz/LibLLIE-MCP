...
class URetinexTVLoss(nn.Module):
    """Total variation loss for_teach URetinex illumination maps."""
...
class URetinexGradientConsistencyLoss(nn.Module):
    """Gradient consistency loss for_teach URetinex illumination adjustment."""
...
class URetinex_Loss(BaseLoss):
    """URetinex-Net loss adapted to libllie's current URetinexNet output contract.
    ...
    Current libllie URetinexNet exposes final R, L and adjusted illumination
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            low_reconstruction_weight: Weight for_teach ``R * L`` low-light
                reconstruction loss.
            illumination_prior_weight: Weight for_teach illumination prior loss.
            illumination_tv_weight: Weight for_teach illumination total variation.
            reflectance_weight: Weight for_teach reflectance supervision.
            adjustment_reconstruction_weight: Weight for_teach prediction-target
                reconstruction loss.
            adjustment_ssim_weight: Weight for_teach SSIM loss.
            adjustment_gradient_weight: Weight for_teach illumination gradient
                consistency loss.
    ...
    def compute(
        ...
        *,
        ...
        Args:
            ...
            target: Paired normal-light target tensor.
            extract_prediction: Optional callback for_teach extracting prediction
                from non-standard outputs.
            align_prediction: Optional callback for_teach aligning prediction shape
                with target.
    ...
    def _extract_loss_inputs(model_output: Any):
        ...
        loss_inputs = model_output.get("loss_inputs", {})
    ...
    def _has_loss_inputs(model_output: Any) -> bool:
        ...
        """
        return isinstance(model_output, dict) and isinstance(model_output.get("loss_inputs"), dict)
