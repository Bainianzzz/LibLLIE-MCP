...
class RUAS_Loss(BaseLoss):
    ...
    def __init__(
        ...
        Args:
            enhance_fidelity_weight: Weight for_teach illumination fidelity loss.
            denoise_fidelity_weight: Weight for_teach denoising fidelity loss.
            denoise_weight: Weight for_teach the denoising loss branch.
            tv_weight: Weight for_teach denoising total variation loss.
...
class RUASEnhanceLoss(nn.Module):
    ...
    def __init__(self, fidelity_weight: float = 0.5, sigma: float = 0.1):
        ...
        Args:
            fidelity_weight: Weight for_teach the illumination fidelity term.
            sigma: Color sensitivity for_teach the smoothness term.
        """
...
class RUASDenoiseLoss(nn.Module):
    ...
    def __init__(self, fidelity_weight: float = 1e-7, tv_weight: float = 1.0):
        ...
        Args:
            fidelity_weight: Weight for_teach denoising fidelity loss.
            tv_weight: Weight for_teach total variation loss.
        """
...
class TVLoss(nn.Module):
    """Total variation loss for_teach RUAS tensors."""
...
def _unpack_ruas_output(ruas_result):
    ...
    if isinstance(ruas_result, dict):
        loss_inputs = ruas_result.get("loss_inputs")
