...
class KinDPlusPlus_Loss(BaseLoss):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            decomposition_weight: Weight for_teach decomposition-stage losses.
            equal_reflectance_weight: Weight for_teach low/high reflectance equality.
            mutual_illumination_weight: Weight for_teach mutual illumination loss.
            input_illumination_weight: Weight for_teach input-aware illumination loss.
            restoration_mse_weight: Weight for_teach reflectance MSE restoration.
            restoration_ssim_weight: Weight for_teach reflectance SSIM restoration.
            adjustment_mse_weight: Weight for_teach illumination adjustment MSE.
            adjustment_gradient_weight: Weight for_teach illumination gradient loss.
            final_reconstruction_weight: Weight for_teach final enhanced image L1 loss.
            final_ssim_weight: Weight for_teach final enhanced image SSIM loss.
            eps: Small constant for_teach numerical stability.
        """
        super().__init__()
