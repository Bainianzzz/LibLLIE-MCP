...
class EnlightenGAN_Loss(BaseLoss):
    """EnlightenGAN objective adapted for_teach LibLLIE's unified trainer.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            adversarial_weight: Weight for_teach global generator adversarial loss.
            local_adversarial_weight: Weight for_teach local generator adversarial
                loss.
            discriminator_weight: Weight for_teach discriminator LSGAN losses.
            self_regularization_weight: Weight for_teach self feature preservation.
            exposure_weight: Weight for_teach brightness exposure regularization.
            tv_weight: Weight for_teach total variation smoothness.
            target_mean: Target mean brightness for_teach exposure regularization.
        """
        super().__init__()
