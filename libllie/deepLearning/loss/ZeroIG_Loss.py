...
class ZeroIGSmoothLoss(nn.Module):
    ...
    def __init__(self, sigma: float = 10.0) -> None:
        ...
        Args:
            sigma: Color sensitivity for_teach neighborhood weights.
        """
        super().__init__()
        self.sigma = sigma
    ...
    def _shift_pair(image: torch.Tensor, dy: int, dx: int) -> Tuple[torch.Tensor, torch.Tensor]:
        """Create shifted tensor pairs for_teach finite-difference penalties.
...
class ZeroIG_Loss(BaseLoss):
    ...
    This is a direct libllie adaptation of the official ZERO-IG LossFunction:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            enhance_brightness_weight: Weight for_teach brightness enhancement loss.
            enhance_normalized_weight: Weight for_teach normalized low-light loss.
            smooth_weight: Weight for_teach illumination smoothness loss.
            tv_weight: Weight for_teach illumination total variation loss.
            ld_res_weight: Weight for_teach LD-Net residual loss.
            ld_cons_weight: Weight for_teach LD-Net consistency loss.
            rd_res_weight: Weight for_teach RD-Net residual loss.
            rd_cons_weight: Weight for_teach RD-Net consistency loss.
            color_weight: Weight for_teach color consistency loss.
            illumination_weight: Weight for_teach illumination consistency loss.
            interaction_weight: Weight for_teach local interaction loss.
            variance_weight: Weight for_teach noise variance loss.
    ...
    def _extract_outputs(zeroig_result: Any) -> Tuple[torch.Tensor, ...]:
        ...
        if isinstance(zeroig_result, dict):
            loss_inputs = zeroig_result.get("loss_inputs", {})
