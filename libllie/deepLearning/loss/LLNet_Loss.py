...
class LLNet_Loss(BaseLoss):
    ...
    implementation exposes those terms in one LibLLIE-compatible supervised
    loss.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            reconstruction_weight: Weight for_teach supervised MSE reconstruction.
            sparsity_weight: Weight for_teach KL sparsity regularization.
            weight_decay: Weight for_teach L2 regularization over autoencoder weights.
    ...
    def forward(
        ...
        *,
        ...
        Args:
            ...
            hidden_activations: Optional encoder activations for_teach sparsity loss.
            weight_tensors: Optional model weights for_teach L2 regularization.
    ...
    def compute(
        ...
        *,
        ...
        loss_inputs = model_output.get("loss_inputs", {}) if isinstance(model_output, dict) else {}
    ...
    def _kl_sparsity(
        ...
        Args:
            ...
            reference: Tensor used for_teach device and dtype placement.
