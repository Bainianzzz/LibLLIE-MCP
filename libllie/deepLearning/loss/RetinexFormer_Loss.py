...
class RetinexFormer_Loss(BaseLoss):
    ...
    illumination consistency term for_teach model outputs that expose stage
    intermediates.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            pixel_weight: Weight for_teach the supervised pixel L1 loss.
            illumination_weight: Weight for_teach optional illumination consistency
                regularization.
        """
        super().__init__()
    ...
    def compute(
        ...
        *,
        ...
        if isinstance(model_output, dict):
            stage_outputs = model_output.get("loss_inputs", {}).get("stage_outputs")
