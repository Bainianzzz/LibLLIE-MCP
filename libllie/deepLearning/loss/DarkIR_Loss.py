...
class DarkIRVGGFeatureLoss(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            loss_weight: Global weight for_teach the feature loss.
    ...
    def _preprocess(self, image: torch.Tensor) -> torch.Tensor:
        """Prepare image tensor for_teach VGG19 feature extraction.
...
class DarkIREdgeLoss(nn.Module):
    ...
    def __init__(self, *, loss_weight: float = 50.0, criterion: str = "l2") -> None:
        ...
        Args:
            loss_weight: Global weight for_teach the edge loss.
...
class DarkIR_Loss(BaseLoss):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            pixel_weight: Weight for_teach the L1 pixel loss.
            perceptual_weight: Weight for_teach VGG feature perceptual loss.
            edge_weight: Weight for_teach Laplacian edge loss.
            lol_weight: Weight for_teach side-output LOL loss.
            ...
            side_upsample_mode: Interpolation mode for_teach side-output upsampling.
        """
        super().__init__()
        ...
        *,
        ...
        Args:
            input_tensor: Low-light input tensor. It is unused by this
                supervised loss but kept for_teach the ``BaseLoss`` interface.
    ...
    def _upsample_side_output(self, side_output: torch.Tensor, target: torch.Tensor) -> torch.Tensor:
        ...
        Args:
            ...
            target: Target tensor used for_teach spatial size.
