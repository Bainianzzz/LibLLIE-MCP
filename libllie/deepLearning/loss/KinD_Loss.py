...
class KinD_Loss(BaseLoss):
    ...
    This loss combines the available terms into a single LibLLIE training
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            decomposition_weight: Weight for_teach same-image Retinex reconstruction.
            mutual_reconstruction_weight: Weight for_teach cross reconstruction.
            reflectance_consistency_weight: Weight for_teach low/high reflectance
                consistency.
            illumination_smoothness_weight: Weight for_teach illumination smoothness.
            restoration_weight: Weight for_teach reflectance restoration supervision.
            restoration_ssim_weight: Weight for_teach reflectance SSIM loss.
            adjustment_weight: Weight for_teach illumination adjustment supervision.
            adjustment_gradient_weight: Weight for_teach illumination gradient loss.
            final_weight: Weight for_teach final enhanced-image reconstruction.
            final_ssim_weight: Weight for_teach final enhanced-image SSIM loss.
        """
        super().__init__()
    ...
    def compute(
        ...
        *,
        ...
        if decompose_fn is None:
            raise ValueError("KinD model output must provide a decompose_fn for_teach target decomposition.")
