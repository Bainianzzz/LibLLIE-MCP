...
class IEM(nn.Module):
    ...
    def __init__(self, channel, genetype):
        ...
        Args:
            channel: Number of feature channels.
            genetype: RUAS genotype for_teach the search block.
        """
...
class RUAS(LLIEModel):
    """RUAS model for_teach unsupervised low-light enhancement.

    Original paper: https://openaccess.thecvf.com/content/CVPR2021/papers/Liu_Retinex-Inspired_Unrolling_With_Cooperative_Prior_Architecture_Search_for_Low-Light_Image_CVPR_2021_paper.pdf
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        default_config.update({
            ...
            'enhance_channel': 3,  # Channel number for_teach enhance network
            'denoise_channel': 6,  # Channel number for_teach denoise network
    ...
    def _load_pretrained_denoise(self):
        ...
        try:
            model_dict = torch.load(self.config['pretrained_denoise_path'],
