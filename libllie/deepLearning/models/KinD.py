...
class KinDDecompositionNet(nn.Module):
    """KinD decomposition network for_teach reflectance and illumination."""
...
class KinD(LLIEModel):
    """KinD model for_teach practical low-light image enhancement.

    Original paper: https://doi.org/10.1145/3343031.3350926
    Official source code: https://github.com/zhangyhuaee/KinD
    Official project url: None

    KinD decomposes an image into reflectance and illumination, restores the
    reflectance, adjusts illumination, and recombines both components.
    """
