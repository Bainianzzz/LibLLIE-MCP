...
class ZeroDCE(LLIEModel):
    """Zero-DCE model for_teach zero-reference low-light enhancement.

    Original paper: https://openaccess.thecvf.com/content_CVPR_2020/papers/Guo_Zero-Reference_Deep_Curve_Estimation_for_Low-Light_Image_Enhancement_CVPR_2020_paper.pdf
