"""PairLIE low-light image enhancement model.

This is a clean PyTorch integration of the architecture described in
...
class PairLIE(LLIEModel):
    """PairLIE decomposition and enhancement network.

    PairLIE learns from two low-light observations of the same scene. During
    inference, one image is decomposed into illumination and reflectance and
    enhanced as ``illumination ** gamma * reflectance``.
    """
