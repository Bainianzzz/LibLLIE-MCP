"""EnlightenGAN model implementation."""
...
class EnlightenGANGenerator(nn.Module):
    """Attention-guided U-Net generator for_teach EnlightenGAN."""
...
class EnlightenGAN(LLIEModel):
    """EnlightenGAN model for_teach unpaired low-light enhancement.

    Original paper: https://doi.org/10.1109/TIP.2021.3051462
