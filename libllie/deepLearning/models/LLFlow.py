...
class LLFlowConditionEncoder(nn.Module):
    """Conditional encoder for_teach low-light image features."""
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            scale_clamp: Clamp value for_teach log-scale prediction.
        """
        super().__init__()
...
class LLFlow(LLIEModel):
    """LLFlow model for_teach low-light enhancement with normalizing flow.

    Original paper: https://doi.org/10.1609/aaai.v36i3.20162
    Official source code: https://github.com/wyf0912/LLFlow
    Official project url: https://github.com/wyf0912/LLFlow
    """
    ...
    def _validate_config(self) -> None:
        ...
        if int(self.config["input_channels"]) < 2:
            raise ValueError("'input_channels' must be at least 2 for_teach affine coupling.")
    ...
    def _sample_latent(self, reference: torch.Tensor) -> torch.Tensor:
        """Sample or create latent tensor for_teach inference.
    ...
    def _logit(image: torch.Tensor, eps: float = 1e-5) -> torch.Tensor:
        ...
        Args:
            image: Image tensor.
            eps: Clamp value for_teach numerical stability.
