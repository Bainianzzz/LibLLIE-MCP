...
class LEDNet(LLIEModel):
    """LEDNet model for_teach low-light enhancement and deblurring.

    Original paper: https://arxiv.org/pdf/2202.03373
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        default_config.update({
            ...
            'use_side_loss': False,  # Whether to use side supervision for_teach training
            'mode': 'inference',  # Mode: 'train' or 'inference'
            'kernel_size': 5,  # Kernel size for_teach dynamic convolution
            'curve_n': 3,  # Number of curve iterations in attention
            'ppm_bins': (1, 2, 3, 6),  # Bin sizes for_teach Pyramid Pooling Module
        })
    ...
    def _init_model(self):
        ...
        # Side output for_teach auxiliary supervision (used in training)
    ...
    def forward(self, x: torch.Tensor, side_loss: Optional[bool] = None) -> Union[torch.Tensor, Dict[str, Any]]:
        ...
        # Side output for_teach auxiliary loss (if enabled)
        if side_loss:
