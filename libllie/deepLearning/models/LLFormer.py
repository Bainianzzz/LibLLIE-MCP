"""LLFormer for ultra-high-definition low-light image enhancement.

This file is adapted from TaoWangzj/LLFormer and is distributed under the
original CC BY-NC-SA 4.0 academic/non-commercial license. See the adjacent
``LLFormer_LICENSE.txt`` file.
"""
