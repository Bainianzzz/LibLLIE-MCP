"""URetinex-Net model implementation."""
...
class DecompositionModule(nn.Module):
    """Decomposition module for_teach separating reflectance and illumination"""
...
class PModule(nn.Module):
    """P update module for_teach the URetinex unfolding process."""
...
class QModule(nn.Module):
    """Q update module for_teach the URetinex unfolding process."""
...
class RestorationModule(nn.Module):
    """Restoration module for_teach refining reflectance"""
...
class URetinexNet(LLIEModel):
    """URetinex-Net model for_teach Retinex-based low-light enhancement.

    Original paper: https://openaccess.thecvf.com/content/CVPR2022/papers/Wu_URetinex-Net_Retinex-Based_Deep_Unfolding_Network_for_Low-Light_Image_Enhancement_CVPR_2022_paper.pdf
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        default_config.update({
            ...
            'gamma': 0.01,  # Weight for_teach P module
            'lambda': 0.01,  # Weight for_teach Q module
            'gamma_offset': 0.01,  # Offset for_teach gamma per iteration
            'lambda_offset': 0.01,  # Offset for_teach lambda per iteration
    ...
    def forward(self, x: torch.Tensor, high_img: Optional[torch.Tensor] = None,
        ...
        Args:
            ...
            high_img: Optional high-light image for_teach adaptive ratio calculation.
