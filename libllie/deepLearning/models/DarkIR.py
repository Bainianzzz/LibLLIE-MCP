...
class LayerNorm2d(nn.Module):
    """Layer normalization over channel dimension for_teach 2D feature maps."""
...
class EBlock(nn.Module):
    ...
    def __init__(self, c, DW_Expand=2, dilations=[1], extra_depth_wise=False):
        ...
        Args:
            ...
            DW_Expand: Depthwise expansion factor.
            dilations: Dilation values for_teach branch convolutions.
...
class DarkIR(LLIEModel):
    """DarkIR model for_teach low-light image restoration.

    Original paper: https://arxiv.org/pdf/2412.13443
                    https://openaccess.thecvf.com/content/CVPR2025/papers/Feijoo_DarkIR_Robust_Low-Light_Image_Restoration_CVPR_2025_paper.pdf
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        default_config.update({
            ...
            'side_loss': False,  # Whether to compute side loss for_teach training
        })
    ...
    def _init_model(self):
        ...
        # Side output for_teach middle loss
    ...
    def forward(self, x: torch.Tensor, side_loss: bool = False, **kwargs) -> Union[torch.Tensor, Dict[str, Any]]:
        ...
        # Side output for_teach loss computation
        ...
        if self.config['mode'] == 'train' and self.config['side_loss']:
            loss_inputs['side_output'] = out_side
