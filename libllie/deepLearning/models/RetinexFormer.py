"""RetinexFormer model implementation."""
...
class RetinexFormerPreNorm(nn.Module):
    """LayerNorm wrapper for_teach channel-last RetinexFormer blocks."""
...
class RetinexFormerDenoiser(nn.Module):
    ...
    def _normalize_num_blocks(
        ...
        """Normalize the number of blocks for_teach all levels.
...
class RetinexFormer(LLIEModel):
    """RetinexFormer model for_teach one-stage Retinex-based low-light enhancement.

    Original paper: https://openaccess.thecvf.com/content/ICCV2023/papers/Cai_Retinexformer_One-stage_Retinex-based_Transformer_for_Low-light_Image_Enhancement_ICCV_2023_paper.pdf
