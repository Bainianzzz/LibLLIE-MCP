...
In LibLLIE, the exposure ratio can be manually specified or automatically estimated from the image luminance mean.

## Location in LibLLIE

| Item | Location |
| --- | --- |
| Algorithm implementation | `libllie/traditional/algorithms/BIMEF.py` |
