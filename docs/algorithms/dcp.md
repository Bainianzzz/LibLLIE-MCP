...
DCP is a traditional enhancement algorithm based on the dark channel prior already implemented in LibLLIE.
...
| Item | Location |
| --- | --- |
| Algorithm implementation | `libllie/traditional/algorithms/DCP.py` |
...
LibLLIE's DCP pipeline includes:
