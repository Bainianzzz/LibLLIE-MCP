...
RCLAHE is a recursive CLAHE enhancement algorithm already implemented in LibLLIE.
...
| Item | Location |
| --- | --- |
| Algorithm implementation | `libllie/traditional/algorithms/RCLAHE.py` |
...
LibLLIE's RCLAHE repeatedly calls the CLAHE processing pipeline inside `_enhance()`.
