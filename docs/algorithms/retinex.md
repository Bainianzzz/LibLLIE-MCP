...
Retinex is a family of traditional low-light enhancement algorithms already implemented in LibLLIE. The current implementation includes SSR, MSR, and MSRCR.
...
LibLLIE currently implements three Retinex variants:
...
| Item | Location |
| --- | --- |
| Algorithm implementation | `libllie/traditional/algorithms/Retinex.py` |
| SSR class name | `SSR` |
| MSR class name | `MSR` |
