...
In LibLLIE, NPE uses a bright-pass illumination estimate, Gaussian smoothing, a bi-log style illumination transform, and a naturalness blending weight.

## Location in LibLLIE

| Item | Location |
| --- | --- |
| Algorithm implementation | `libllie/traditional/algorithms/NPE.py` |
