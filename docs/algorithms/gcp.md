...
GCP is a Gamma Correction Prior low-light enhancement algorithm implemented in LibLLIE, corresponding to the paper “Low-light image enhancement using gamma correction prior in mixed color spaces”.
...
The LibLLIE implementation refers to the official open-source script. The main pipeline includes:
...
| Item | Location |
| --- | --- |
| Algorithm implementation | `libllie/traditional/algorithms/GCP.py` |
